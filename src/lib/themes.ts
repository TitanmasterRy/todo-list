...
export const THEMES: ThemeDef[] = [
  ...
  },
  {
    ...
    darkVars: { '--bg': '#0a0a0b', '--bg-elev': '#111113', '--bg-elev-2': '#18181b', '--bg-hover': '#1f1f23', '--border': '#232327', '--border-strong': '#333338', '--accent': '#e8eaf0' },
  ...
  },
  {
    ...
    lightVars: { '--bg': '#fff4f8', '--bg-elev': '#ffffff', '--bg-elev-2': '#ffe9f1', '--bg-hover': '#ffdfea', '--border': '#ffd3e2', '--border-strong': '#f7b5cc', '--text': '#4a2a3a', '--text-muted': '#8a5a72' },
  },
  {
    id: 'arcade',
    name: 'Arcade',
    ...
    darkVars: { '--bg': '#050510', '--bg-elev': '#0b0b1e', '--bg-elev-2': '#12122b', '--bg-hover': '#1a1a3a', '--border': '#22224a', '--border-strong': '#3a3a7a', '--text': '#e8f7ff', '--text-muted': '#8ea0c8' },
    lightVars: { '--bg': '#0b0b1e', '--bg-elev': '#12122b', '--bg-elev-2': '#1a1a3a', '--bg-hover': '#22224a', '--border': '#2a2a5a', '--border-strong': '#3a3a7a', '--text': '#e8f7ff', '--text-muted': '#8ea0c8', '--text-faint': '#6a7aa8' },
  },
  {
    id: 'nature',
    name: 'Nature',
    ...
    lightVars: { '--bg': '#f4f1e6', '--bg-elev': '#fffdf5', '--bg-elev-2': '#ece7d3', '--bg-hover': '#e3dcc2', '--border': '#dcd5bb', '--border-strong': '#c3b998', '--text': '#243120', '--text-muted': '#5e6b5a' },
  },
  {
    id: 'space',
    name: 'Space',
    ...
    darkVars: { '--bg': '#070914', '--bg-elev': '#0d1024', '--bg-elev-2': '#141936', '--bg-hover': '#1b2147', '--border': '#1f2650', '--border-strong': '#33407a', '--text': '#e9ecff', '--text-muted': '#9aa5d6' },
  ...
  },
  {
    ...
    darkVars: { '--bg': '#1c1a17', '--bg-elev': '#24211d', '--bg-elev-2': '#2e2a25', '--bg-hover': '#38332d', '--border': '#3a352e', '--border-strong': '#54493d', '--text': '#efe6d6', '--text-muted': '#b5a992' },
    lightVars: { '--bg': '#f7f2e8', '--bg-elev': '#fffdf8', '--bg-elev-2': '#f0e9da', '--bg-hover': '#e8dfcb', '--border': '#e1d7c2', '--border-strong': '#c9bb9d', '--text': '#2b2620', '--text-muted': '#6b5f4e' },
  },
];
