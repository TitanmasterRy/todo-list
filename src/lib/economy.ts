...
export const SHOP: ShopItem[] = [
  // currency
  { id: 'chips-100', name: '100 chips', emoji: '🎰', description: 'A starter stack for the casino.', price: 10, pay: 'coins', kind: 'chips', section: 'currency', grant: { currency: 'chips', amount: 100 } },
  { id: 'chips-550', name: '550 chips', emoji: '🎰', description: '10% bonus chips.', price: 50, pay: 'coins', kind: 'chips', section: 'currency', grant: { currency: 'chips', amount: 550 } },
  { id: 'chips-1200', name: '1,200 chips', emoji: '💰', description: '20% bonus chips.', price: 100, pay: 'coins', kind: 'chips', section: 'currency', grant: { currency: 'chips', amount: 1200 } },
  { id: 'voucher-1', name: 'Arcade voucher', emoji: '🎟️', description: 'One play of an arcade game.', price: 15, pay: 'coins', kind: 'vouchers', section: 'currency', grant: { currency: 'vouchers', amount: 1 } },
  { id: 'voucher-5', name: '5 arcade vouchers', emoji: '🎟️', description: 'Five plays, one free.', price: 60, pay: 'coins', kind: 'vouchers', section: 'currency', grant: { currency: 'vouchers', amount: 5 } },
  // boosts
  { id: 'freeze', name: 'Streak freeze', emoji: '🧊', description: 'Protects your streak for one missed day (max 2 banked).', price: 60, pay: 'coins', kind: 'freeze', section: 'boosts' },
  { id: 'booster', name: 'Coin booster', emoji: '⚡', description: 'Your next 3 completed tasks pay double coins.', price: 40, pay: 'coins', kind: 'booster', section: 'boosts', grant: { currency: 'item:booster', amount: 3 } },
  // cosmetics
  { id: 'title-scholar', name: 'Title: Scholar', emoji: '🎓', description: 'Shown next to your level.', price: 100, pay: 'coins', kind: 'title', section: 'cosmetics', unique: true },
  { id: 'title-night-owl', name: 'Title: Night Owl', emoji: '🦉', description: 'Shown next to your level.', price: 150, pay: 'coins', kind: 'title', section: 'cosmetics', unique: true },
  { id: 'title-speedrunner', name: 'Title: Speedrunner', emoji: '⏱️', description: 'Shown next to your level.', price: 200, pay: 'coins', kind: 'title', section: 'cosmetics', unique: true },
  ...
  { id: 'frame-gold', name: 'Gold frame', emoji: '🥇', description: 'A gold ring around your level card.', price: 150, pay: 'coins', kind: 'frame', section: 'cosmetics', unique: true },
  ...
  { id: 'confetti-coins', name: 'Coin confetti', emoji: '🪙', description: 'Celebrations rain coins.', price: 120, pay: 'coins', kind: 'confetti', section: 'cosmetics', unique: true },
  { id: 'confetti-hearts', name: 'Heart confetti', emoji: '💖', description: 'Celebrations rain hearts.', price: 120, pay: 'coins', kind: 'confetti', section: 'cosmetics', unique: true },
  { id: 'confetti-stars', name: 'Star confetti', emoji: '🌟', description: 'Celebrations rain stars.', price: 120, pay: 'coins', kind: 'confetti', section: 'cosmetics', unique: true },
  { id: 'confetti-books', name: 'Book confetti', emoji: '📚', description: 'Celebrations rain books and pencils.', price: 120, pay: 'coins', kind: 'confetti', section: 'cosmetics', unique: true },
  // prize counter (chips)
  ...
  { id: 'title-high-roller', name: 'Title: High Roller', emoji: '🎩', description: 'Casino-only title.', price: 50_000, pay: 'chips', kind: 'title', section: 'prizes', unique: true },
];
